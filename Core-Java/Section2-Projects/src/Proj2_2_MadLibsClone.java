...
public class Proj2_2_MadLibsClone {
    public static void main(String [] args){
        ...
        System.out.println("She loved to wear " +clothing+ " and to " + hobby + ". She wanted to marry " + adjective3+ " " +occupation2 + " named " + boysName + " but her father , King " + mansName + " forbids her from seeing him.");
